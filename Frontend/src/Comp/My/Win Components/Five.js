...
const Five = ({ disabled ,availableBalance,setAvailableBalance,handleNumberPrediction}) => {
    ...
    return (
        <div>
            ...
            <Button data-v-3acbc54d="" disabled={disabled} onClick={buttonclick} className="btn split1" data-num="0">5</Button>
