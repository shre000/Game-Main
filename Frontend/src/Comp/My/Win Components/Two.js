...
const Two = ({ disabled,availableBalance,setAvailableBalance,handleNumberPrediction }) => {
    ...
    return (
        <div>
            ...
            <Button data-v-3acbc54d="" disabled={disabled} onClick={buttonclick} className="btn btn-danger" data-num="0">2</Button>

            <Modal show={show} onHide={handleClose}>
                <Modal.Header className='global-bg text-light'>
                    <Modal.Title className='fs-5 text-center'>Select 2</Modal.Title>
                </Modal.Header>
                <Modal.Body> 
