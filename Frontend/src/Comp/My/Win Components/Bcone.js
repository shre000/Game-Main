...
const Bcone = () => {
  return (
    <><div>
    <p className='text-center'><i class="fa-solid fa-trophy fa-bounce"><br /></i>Bcone Record</p>
    ...
    <div className="container mb-5">
        ...
        <nav aria-label="Page navigation example" className='align-content-end'>
                ...
                <div className="container">
                    <p className='text-center'><i class="fa-solid fa-book fa-bounce"></i>My Bcone Record</p>
                    <Records/>
                </div>
    </div>
</>
